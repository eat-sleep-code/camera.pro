...
clientSecretsFile = '/home/pi/camera/youtube/config.json'
missingClientSecretsMessage = 'Could not locate client secrets file!'
tokenFile = '/home/pi/camera/youtube/token.json'
...
parser.add_argument('-t', '--title', type=str, default='Camera.PRO Video', help='Title of the video')
parser.add_argument('-d', '--description', type=str, default='Video', help='Description of the video')
parser.add_argument('-k', '--keywords', type=str, default='Camera.PRO', help='Comma-seperated list of keywords')
